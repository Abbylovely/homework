...
print("Second item:", colour[1])
print("Third item:", colour[2]) 

colour[1] = "yellow"
print("After changing second item:", colour)  # ["gold", "yellow", "rose gold"]

colour.append("silver")
print("After appending an item:", colour)  # ["gold", "yellow", "rose gold", "silver"]

#colour.remove("white")
#print("After removing an item by value:", colour)  # ["gold", "white", "rose gold", "silver"]

colour.pop(2)
print("After removing an item by position:", colour)   #["gold", "pink", "silver"]

print("Looping through the list:")
for colour in colour:
    print(colour)

print("Slicing the list (items 1 to 2):", colour[1:3])   #["pink", "silver"]

#colour.sort()
#print("After sorting the list:", colour)  # ["gold", "pink", "silver"]

#colour.reverse()
#print("After reversing the list:", colour)  # ["silver", "pink", "gold"]

#colour_copy = colour.copy()
#print("Copy of the list:", colour_copy)   #["silver", "pink", "gold"]
